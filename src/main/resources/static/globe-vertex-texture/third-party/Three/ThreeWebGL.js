...
THREE.Ray.prototype = {
    intersectScene: function (b) {
        ...
        var e, g, h, o, n, q, r, v, E, F, H, I = b.geometry, M = I.vertices, N = [];
        e = 0;
...
THREE.Matrix4.prototype = {
    set: function (b, d, e, g, h, o, n, q, r, v, E, F, H, I, M, N) {
        ...
        var e = b.n11, g = b.n12, h = b.n13, o = b.n14, n = b.n21, q = b.n22, r = b.n23, v = b.n24, E = b.n31, F = b.n32, H = b.n33, I = b.n34, M = b.n41, N = b.n42, V = b.n43, L = b.n44, ra = d.n11, da = d.n12, pa = d.n13, $ = d.n14, K = d.n21, Ia = d.n22,
            ca = d.n23, Fa = d.n24, fa = d.n31, R = d.n32, c = d.n33, ga = d.n34;
        ...
        var b = this.n11, d = this.n12, e = this.n13, g = this.n14, h = this.n21, o = this.n22, n = this.n23, q = this.n24, r = this.n31, v = this.n32, E = this.n33, F = this.n34, H = this.n41, I = this.n42, M = this.n43, N = this.n44;
        ...
        var e = Math.cos(d), g = Math.sin(d), h =
            1 - e, o = b.x, n = b.y, q = b.z, r = h * o, v = h * n;
        ...
        var d = b.x, e = b.y, g = b.z, h = b.w, o = d + d, n = e + e, q = g + g;
        b = d * o;
        var r = d * n;
        d *= q;
        var v = e * n;
...
THREE.Matrix4.makeInvert = function (b, d) {
    var e = b.n11, g = b.n12, h = b.n13, o = b.n14, n = b.n21, q = b.n22, r = b.n23, v = b.n24, E = b.n31, F = b.n32, H = b.n33, I = b.n34, M = b.n41, N = b.n42, V = b.n43, L = b.n44;
...
THREE.Matrix4.makeInvert3x3 = function (b) {
    var d = b.m33, e = d.m, g = b.n33 * b.n22 - b.n32 * b.n23, h = -b.n33 * b.n21 + b.n31 * b.n23, o = b.n32 * b.n21 - b.n31 * b.n22, n = -b.n33 * b.n12 + b.n32 * b.n13, q = b.n33 * b.n11 - b.n31 * b.n13, r = -b.n32 * b.n11 + b.n31 * b.n12, v = b.n23 * b.n12 - b.n22 * b.n13, E = -b.n23 * b.n11 + b.n21 * b.n13, F = b.n22 * b.n11 - b.n21 * b.n12;
...
THREE.Quaternion.prototype = {
    ...
    multiplySelf: function (b) {
        var d = this.x, e = this.y, g = this.z, h = this.w, o = b.x, n = b.y, q = b.z;
        b = b.w;
        ...
        d || (d = b);
        var e = b.x, g = b.y, h = b.z, o = this.x, n = this.y, q = this.z, r = this.w, v = r * e + n * h - q * g, E =
            r * g + q * e - o * h, F = r * h + o * g - n * e;
        e = -o * e - n * g - q * h;
        d.x = v * r + e * -o + E * -q - F * -n;
        d.y = E * r + e * -n + F * -o - v * -q;
        d.z = F * r + e * -q + v * -n - E * -o;
...
THREE.Geometry.prototype = {
    computeCentroids: function () {
        ...
        var d, e, g, h, o, n, q = new THREE.Vector3, r = new THREE.Vector3;
        g = 0;
        ...
        var d, e, g, h, o, n, q, r, v, E, F, H, I, M, N, V, L, ra, da, pa, $, K, Ia, ca, Fa = [], fa = [], R = new THREE.Vector3, c = new THREE.Vector3, ga = new THREE.Vector3, xa = new THREE.Vector3, sa = new THREE.Vector3;
        d = 0;
...
THREE.ShadowVolume.prototype.facesShareEdge = function (b, d, e) {
    var g, h, o, n, q, r, v, E, F, H, I, M, N, V = 0, L = ["a", "b", "c", "d"];
        ...
        for (N = 0; N < h; N++) {
            ...
            if (Math.abs(q.position.x - r.position.x) < 1.0E-4 && Math.abs(q.position.y - r.position.y) < 1.0E-4 && Math.abs(q.position.z - r.position.z) < 1.0E-4) {
                ...
                if (V === 2) {
                    I += L[M];
                    return I === "ad" || I === "ac" ? {
                            faces: [d, e], vertices: [v, E, r, q], indices: [F,
...
THREE.Projector = function () {
    ...
    function e(R, c) {
        var ga = 0, xa = 1, sa = R.z + R.w, ya = c.z + c.w, Y = -R.z + R.w, na = -c.z + c.w;
        if (sa >= 0 && ya >= 0 && Y >= 0 && na >= 0)return !0; else if (sa < 0 && ya < 0 || Y < 0 && na < 0)return !1; else {
            if (sa < 0) ga = Math.max(ga, sa / (sa - ya)); else ya < 0 && (xa = Math.min(xa, sa / (sa - ya)));
            if (Y < 0) ga = Math.max(ga, Y / (Y - na)); else na < 0 && (xa = Math.min(xa, Y / (Y - na)));
            if (xa < ga)return !1; else {
                R.lerpSelf(c, ga);
                c.lerpSelf(R, 1 - xa);
                return !0
            }
    ...
    var g,
        h, o = [], n, q, r = [], v, E, F = [], H, I = [], M, N, V = [], L, ra, da = [], pa = new THREE.Vector4, $ = new THREE.Vector4, K = new THREE.Matrix4, Ia = new THREE.Matrix4, ca = [new THREE.Vector4, new THREE.Vector4, new THREE.Vector4, new THREE.Vector4, new THREE.Vector4, new THREE.Vector4], Fa = new THREE.Vector4, fa = new THREE.Vector4;
    ...
    this.projectScene = function (R, c, ga) {
        var xa = [], sa = c.near, ya = c.far, Y, na, oa, ha, Z, va, qa, za, Aa, aa, Pa, Ta, Xa, Ua, Sa, S, J;
        ra = N = H = E = 0;
...
THREE.WebGLRenderer = function (b) {
    function d(f, p, j) {
        var k, m, x, y = f.vertices, u = y.length, A = f.colors, t = A.length, w = f.__vertexArray, z = f.__colorArray, D = f.__sortArray, B = f.__dirtyVertices, O = f.__dirtyColors;
        if (j.sortParticles) {
    ...
    function e(f, p, j, k, m) {
        ...
        var x = k.program, y = x.uniforms, u = k.uniforms;
        if (x !=
            sa) {
            c.useProgram(x);
            sa = x
        ...
        if (k instanceof THREE.MeshPhongMaterial || k instanceof THREE.MeshLambertMaterial ||
            k.lights) {
            var A, t, w = 0, z = 0, D = 0, B, O, W, P, X = Sa, Ga = X.directional.colors, T = X.directional.positions, Q = X.point.colors, U = X.point.positions, ta = X.point.distances, s = 0, G = 0;
            j = t = P = 0;
        ...
        for (var i in u)if (z = x.uniforms[i]) {
            ...
            w = A.type;
            j = A.value;
            if (w == "i") c.uniform1i(z, j); else if (w == "f") c.uniform1f(z, j); else if (w == "fv1") c.uniform1fv(z, j); else if (w == "fv") c.uniform3fv(z, j); else if (w == "v2") c.uniform2f(z, j.x, j.y); else if (w == "v3") c.uniform3f(z, j.x, j.y, j.z); else if (w == "v4") c.uniform4f(z, j.x, j.y, j.z, j.w); else if (w == "c") c.uniform3f(z, j.r, j.g, j.b); else if (w == "t") {
                c.uniform1i(z, j);
        ...
        if (k.opacity != 0) {
            ...
            if (!k.morphTargets && f.position >= 0) {
                ...
                if (x.morphTargetForcedOrder.length) {
                    ...
                    var z, D = A.length;
                    j = 0;
                    for (x.morphTargetBase !== -1 && (u[x.morphTargetBase] = !0); j < k.numSupportedMorphTargets;) {
    ...
    function E(f) {
        var p, j, k = f.object, m = f.opaque, x = f.transparent;
        x.count = 0;
        f = m.count = 0;
    ...
    function F(f) {
        var p, j, k, m, x = f.object, y = f.buffer, u = f.opaque, A = f.transparent;
        A.count = 0;
        f = u.count = 0;
    ...
    function I(f) {
        ...
        var p, j = f.lights.length, k, m = f.lights, x = [], y, u, A, t, w, z = f.__webglShadowVolumes.length;
        for (p = 0; p < j; p++) {
            k = f.lights[p];
    ...
    function M(f, p) {
        ...
        var x = _sprite.uniforms, y = Aa / za, u, A = [], t = za * 0.5, w = Aa * 0.5, z = !0;
    ...
    function N(f, p) {
        var j, k, m = f.__webglLensFlares.length, x, y, u, A = new THREE.Vector3, t = Aa / za, w = za * 0.5, z = Aa * 0.5, D = 16 / Aa, B = [D * t, D], O = [1, 1, 0], W = [1, 1], P = J.uniforms;
        j = J.attributes;
        ...
        if (f instanceof THREE.Mesh) {
            ...
            for (p in j.geometryGroups) {
                ...
                if (j.__dirtyVertices || j.__dirtyMorphTargets || j.__dirtyElements || j.__dirtyUvs || j.__dirtyNormals || j.__dirtyColors || j.__dirtyTangents || x) {
                    x = c.DYNAMIC_DRAW;
                    var y = void 0, u = void 0, A = void 0, t = void 0;
                    A = void 0;
                    var w = void 0, z = void 0, D = void 0, B = void 0, O = void 0, W = void 0, P = void 0, X = void 0, Ga = void 0,
                        T = void 0, Q = void 0, U = void 0, ta = void 0;
                    z = void 0;
                    D = void 0;
                    t = void 0;
                    B = void 0;
                    t = void 0;
                    var s = void 0, G = void 0;
                    z = void 0;
                    s = void 0;
                    G = void 0;
                    ...
                    G = void 0;
                    i = void 0;
                    var Va = void 0, ua = 0, Ba = 0, Za = 0, $a = 0, Ja = 0, La = 0, ea = 0, Ma = 0, wa = 0, C = 0, Ca = 0;
                    G = s = 0;
                    var Da = k.__vertexArray, fb = k.__uvArray, gb = k.__uv2Array, Qa = k.__normalArray, ia = k.__tangentArray, Ea = k.__colorArray,
                        ja = k.__skinVertexAArray, ka = k.__skinVertexBArray, la = k.__skinIndexArray, ma = k.__skinWeightArray, hb = k.__morphTargetsArrays, Ra = k.__webglCustomAttributes;
                    i = void 0;
                    var Na = k.__faceArray, Oa = k.__lineArray, qb = k.__needsSmoothNormals;
                    W = k.__vertexColorType;
                    O = k.__uvType;
                    P = k.__normalType;
                    var Ha = f.geometry, ib = Ha.__dirtyVertices, jb = Ha.__dirtyElements, eb = Ha.__dirtyUvs, kb = Ha.__dirtyNormals, lb = Ha.__dirtyTangents, mb = Ha.__dirtyColors, nb = Ha.__dirtyMorphTargets, ab = Ha.vertices, rb = k.faces, ub = Ha.faces, sb = Ha.faceVertexUvs[0],
                        tb = Ha.faceVertexUvs[1], bb = Ha.skinVerticesA, cb = Ha.skinVerticesB, db = Ha.skinIndices, Wa = Ha.skinWeights, Ya = f instanceof THREE.ShadowVolume ? Ha.edgeFaces : undefined;
    ...
    function ra(f) {
        ...
        var j, k, m, x, y, u, A, t, w = {}, z = f.morphTargets !==
    ...
    function da(f, p, j) {
        f.push({buffer: p, object: j, opaque: {list: [], count: 0}, transparent: {list: [], count: 0}})
    }
    ...
    this.initMaterial = function (f, p, j, k) {
        var m, x, y;
        if (f instanceof THREE.MeshDepthMaterial) y = "depth"; else if (f instanceof THREE.ShadowVolumeDynamicMaterial) y = "shadowVolumeDynamic"; else if (f instanceof THREE.MeshNormalMaterial) y = "normal"; else if (f instanceof THREE.MeshBasicMaterial) y =
            "basic"; else if (f instanceof THREE.MeshLambertMaterial) y = "lambert"; else if (f instanceof THREE.MeshPhongMaterial) y = "phong"; else if (f instanceof THREE.LineBasicMaterial) y = "basic"; else f instanceof THREE.ParticleBasicMaterial && (y = "particle_basic");
        if (y) {
    ...
    this.render = function (f, p, j, k) {
        var m, x, y, u, A, t, w, z, D = f.lights, B = f.fog;
        R.data.vertices = 0;
        R.data.faces = 0;
        R.data.drawCalls = 0;
    ...
    this.initWebGLObjects = function (f) {
        ...
        for (; f.__objectsAdded.length;) {
            var p =
                f.__objectsAdded[0], j = f, k = void 0, m = void 0, x = void 0;
            ...
            if (p instanceof THREE.Mesh) {
                ...
                for (k in m.geometryGroups) {
                    ...
                    if (!x.__webglVertexBuffer) {
                        ...
                        y = x;
                        u = p;
                        var t = void 0, w = void 0, z = void 0;
                        z = void 0;
                        ...
                        for (B = t.length; D < B; D++)if (t[D].attributes) {
                            ...
                            for (a in t[D].attributes) {
                                ...
                                if (!w.__webglInitialized || w.createUniqueBuffers) {
                                    ...
                                    O = 1;
                                    if (w.type === "v2") O = 2; else if (w.type === "v3") O = 3; else if (w.type === "v4") O = 4; else w.type === "c" && (O = 3);
                                    w.size = O;
                                    w.needsUpdate = !0;
            ...
            } else if (p instanceof THREE.LensFlare) da(j.__webglLensFlares, undefined, p); else if (p instanceof THREE.Ribbon) {
                m = p.geometry;
                ...
                object: p,
                opaque: {list: [], count: 0}, transparent: {list: [], count: 0}
    ...
    this.setFaceCulling = function (f, p) {
        if (f) {
            !p || p == "ccw" ? c.frontFace(c.CCW) : c.frontFace(c.CW);
