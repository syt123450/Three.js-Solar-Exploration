...
SolarSystemSceneController = function(renderer) {
    ...
    function judgeChangeScene() {
        ...
        //只能取到universeMesh, 其他所有的都取不到
        // for (var i = 0; i < intersects.length; i++) {
        //     if (intersects[i].object === earthAggregation) {
        //         console.log(111);
        //     }
        // }

        if (intersects !== null && intersects.length !== 0 && intersects[0].object !== universeMesh) {
