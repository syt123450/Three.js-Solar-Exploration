...
| Yuntian| **See the whole**</br>The universeUtils and SolarSceneController has some same responsibility, so I refactor it to avoid duplicate. </br></br>**Communication**</br>This week, I communicate with bo to implement some features and joint debugging with chen to ensure the usability of the backend service.</br></br>**Decide as late as possible**</br>I did a info board in the front end regardless with the design, I only show function and we can decide the design later.</br>|
